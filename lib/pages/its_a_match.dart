...
class _ItsAMatchPageState extends State<ItsAMatchPage> {
  ...
  Future<void> _saySomething() async {
    ...
    final chatId = await SuggestionsService.matchWith(widget.profile.uid);
    await updateNumRightSwipedRemoveFromListAndGoneThrough(
      context,
      widget.profile.uid,
      likedUser: true,
      isRespondedSuggestion: true,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return _isLoadingChat
        ? LoadingPage(
            label: 'Creating your chat...',
          )
        : Material(
            child: Stack(
              children: <Widget>[
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    ...
                    onTapDown: (_) =>
                        setState(() => _saySomethingPressed = true),
                    onTapUp: (_) {
