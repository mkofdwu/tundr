...
var serviceAccount =
  process.env.NODE_ENV === 'production'
    ? require('/home/leejiajie/dev/keys/tundr-689a7-firebase-adminsdk-x8vcu-1a5a303a45.json')
    : require('/home/leejiajie/dev/keys/tundr-android-dev-firebase-adminsdk-smgco-335f2bca38.json');

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: 'https://tundr-android-dev.firebaseio.com',
});
